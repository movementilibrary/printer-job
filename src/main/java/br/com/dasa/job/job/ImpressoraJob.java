...
public class ImpressoraJob implements Serializable {
    ...
    public void deletaImpressorasAtivas(List<Impressora> listaImpressorasDevemSerExcluidas) {
        try {
            ...
            listaImpressorasDevemSerExcluidas.forEach(excluirImpressoraInativa -> restTemplate.delete(URL_DELETAR_IMPRESSORAS + "/" .concat(criaIdImpressora(excluirImpressoraInativa.getUnidade(), excluirImpressoraInativa.getMacaddress()))));
